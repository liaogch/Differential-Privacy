function [ Opt_U,Opt_epsilon_max, Opt_num,U] = ProspectTheoryBased_TruncatedNormal_GMPTPara( Lambda_spec,Beta_spec,Alpha,Mu,Ref,N,C,average,sigma,lower,upper,iteration,Epsilon_searchrange )
