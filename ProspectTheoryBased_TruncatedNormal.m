function [ Opt_U,Opt_epsilon_max, Opt_num] = ProspectTheoryBased_TruncatedNormal( Lambda,Beta,Alpha,Mu,Ref,Num,C,average,sigma,lower,upper,iteration,Epsilon_searchrange )
